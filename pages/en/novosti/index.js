 ...
 <figcaption>
    ...
    const showLoadedBlogs = () => {
        return loadedBlogs.map((blog, i) => (
            <article  style={{}}  className='m-4'  key={i}>
                    ...
                    <div className="cotainer-fluid pt-2 pb-3 ">
                        ...
                        <header className='text-left ml-5 mr-5'> 
                             <CategoryMenu/>             
                              ...
                              {bloglist.length === 0 ? <p className='' style={{textTransform:'uppercase',fontSize:'',color:'#c1c8e4'}}> Sorry, there is no news at the moment</p> :
<div>
<hr className=''  style={{textTransform:'uppercase',fontSize:'small',color:'#c1c8e4'}} />
<p className='pb-0 mb-0' style={{textTransform:'uppercase',fontSize:'small',color:'#c1c8e4'}} >Total news <b style={{fontSize:'medium'}}>
{bloglist.length}
   </b>
</p>
</div>
